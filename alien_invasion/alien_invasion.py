...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.init()
        self.settings = Settings(self,ship,bullet,alien)
    ...
    def _check_aliens_bottom(self):
        """Check if any aliens reached bottom screen."""
    ...
    def _check_fleet_edges(self):
        """When aliens reach the edge of screen."""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        """Update images in screen, flip to new screen"""
